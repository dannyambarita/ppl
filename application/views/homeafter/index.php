...
<head>
    ...
    <div class="container" style="">
        <div class="row">
            <div class="col">
                <center>
                    <p>WELCOME TO JON'S Boulangerie Patisserie</p>
                </center>
                <hr style="">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-4">
                <center>
                    ...
                    <p style="font-weight:bold">— Courtney Arnold</p>
                </center>
            </div>
            ...
            <div class="col-4">
                <center>
                    ...
                    <p style="font-weight:bold">— Emmett Carrillo</p>
                </center>
            </div>
            ...
            <div class="col-4">
                <center>
                    ...
                    <p style="font-weight:bold"> — Virginia Griffin</p>
                </center>
            </div>
        </div>
    </div>
